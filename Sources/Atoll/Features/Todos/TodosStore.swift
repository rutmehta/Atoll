...
final class TodosStore: ObservableObject {
    ...
    private init() {
        ...
        let dir = base.appendingPathComponent("Atoll", isDirectory: true)
    ...
    private func load() {
        ...
        do {
            ...
            NSLog("Atoll Todos: failed to decode todos.json (%@); backing it up and starting fresh",
    ...
    private func save() {
        ...
        do {
            ...
            NSLog("Atoll Todos: save failed: %@", String(describing: error))
        }
    }
