...
/// `~/Library/Application Support/AgentNook/notes.json` with a 0.5 s
...
final class NotesStore: ObservableObject {
    ...
    private func saveNow() {
        ...
        do {
            ...
            NSLog("AgentNook Notes: save failed: \(error)")
        }
    }
    ...
    private func load() {
        ...
        do {
            ...
            NSLog("AgentNook Notes: load failed, keeping corrupt file aside: \(error)")
