...
struct TimersSettingsView: View {
    ...
    private var notificationRow: some View {
        if !manager.notificationsAvailable {
            Label {
                Text("Notifications require the bundled AgentNook.app build.")
            ...
            case .authorized, .provisional:
                Label {
                    Text("A banner is posted when a timer finishes — even if AgentNook was quit.")
                        .foregroundStyle(.secondary)
                } icon: {
            ...
            case .denied:
                HStack {
                    Label {
                        Text("Notifications are turned off for AgentNook.")
                            .foregroundStyle(.secondary)
                    } icon: {
