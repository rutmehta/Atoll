    ...
    var body: some View {
        Form {
            Section {
                ...
                Text("Items stay on the shelf across restarts unless cleared. Files are referenced in place — dropped data and pasted images are stored in AgentNook's Application Support folder.")
                    .font(.system(size: 11))
